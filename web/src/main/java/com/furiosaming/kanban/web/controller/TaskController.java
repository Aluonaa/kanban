...
public class TaskController {
    ...
    @PostMapping(value = "/search1", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "taskList/{id}/tasks", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public PagingResponseDto<List<TaskDto>> allTaskOfTaskList(@PathVariable Long id, @RequestBody PagingRequestDto<TaskFilter> pagingRequestDto) {
    ...
    public BaseResponseDto<TaskDto> getByIdTask(@PathVariable Long id) {
    ...
    public BaseResponseDto<TaskDto> newTask(@RequestBody TaskDto taskDto) {
    ...
    public BaseResponseDto<TaskDto> deleteTask(@PathVariable Long id) {
